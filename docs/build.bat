...
set JAVA_HOME=C:\Users\Thalukanyo\Documents\OpenJDK_winx64\jdk-11.0.10+9
set JAVAFX_HOME=C:\Users\Thalukanyo\Documents\openjfx-11.0.2_windows-x64_bin-sdk\javafx-sdk-11.0.2
...
javadoc --module-path %JAVAFX_HOME%\lib --add-modules=%JAVAFX_MODULES% -sourcepath %PRAC_SRC% -classpath %PRAC_BIN%;%PRAC_LIB% -use -version -author -d %PRAC_DOCS%\JavaDocs -subpackages acsse.csc2b
IF /I "%ERRORLEVEL%" NEQ "0" (
